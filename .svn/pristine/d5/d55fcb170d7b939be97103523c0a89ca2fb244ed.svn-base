...
const todoReducer = (state = initialState, action) => {
    ...
    switch(action.type){
        ...
        case types.HANDLE_TOGGLE :
            ...
            return {
                ...state,
                groupTodos: nextTodoList.filter(todo => todo.groupId === parseInt(action.groupId))
            };
        // 할 일 삭제
        ...
        case CREATE_ITEM_MODAL:
            state = {
                ...
                todos : state.todos.concat({
                    ...
                    id: todoId++,
                    checked: false,
                    groupId: parseInt(action.item.groupId)
                }),
                groupName : action.item.groupName,
            }
            state.groupTodos = [...state.todos]
            return {
                ...state,
                ...
                groupTodos: state.groupTodos.filter(todo => todo.groupId === parseInt(action.item.groupId))
            };
        ...
        case types.HANDLE_SUBTOGGLE :
            ...
            state = {
                ...state,
                groupTodos: copyTodoList.filter(todo => todo.groupId === action.todo.groupId),
                groupName: state.groupName,
                groupId: state.groupId
            }
